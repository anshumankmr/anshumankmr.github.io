...
date: '2026-06-27'
articleId: 645835f4-8bb7-48f7-a22e-d11a5f65f3e5
...
At some point — honestly, about a year ago — I knew the setup was overkill. The content pipeline, the CMS, the deploy tooling — none of it was making the writing better. It was just cost and complexity I'd been carrying long enough that dismantling it felt like more effort than keeping it.

The GCP bill was the thing that finally made the effort feel worth it. So I cut it.

Strapi is gone — the posts live as markdown files fetched from a JSON file on GitHub. GitHub Actions builds it. Cloudflare Pages serves it for free. No database, no CMS, no IAM roles. The pipeline is one YAML file and a single deploy command.
